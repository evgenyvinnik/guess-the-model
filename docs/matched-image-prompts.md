...
This is the original 2026-09-12 batch of fox, robot, and teapot scenes. New games now use 113 saved originals from the harder [challenge image prompts](challenge-image-prompts.md). The combined saved collection contains 127 images. These fourteen originals remain saved and registered for historical statistics and image references; `activeGeneratedImages` excludes them while completed challenge images exist.
